 ...
 */
@ThreadSafe
public class Declare extends Node implements Query, Serializable {
     ...
     */
    public Declare(final String cmd,
                  final String data,
        ...
        if (cmd.isEmpty()) {
            throw new InvalidParameterException(INVALID_DECLARE_CMD);
        }

        if (data.isEmpty()) {
            throw new InvalidParameterException(INVALID_DECLARE_DATA);
        }
    }
