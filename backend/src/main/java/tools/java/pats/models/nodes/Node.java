package tools.java.pats.models.nodes;

import net.jcip.annotations.ThreadSafe;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import tools.java.pats.models.constants.ProjectStaticConstants;
import tools.java.pats.models.formatters.ColumnsWithinParensFormatter;
import tools.java.pats.models.formatters.EmbeddedSelects.EmbeddedSelectsFormatter;
import tools.java.pats.models.formatters.MultiLineSegmentsFormatter;
import tools.java.pats.models.formatters.Operators.Factory.OperatorsFormatterFactory;
import tools.java.pats.models.formatters.Operators.OperatorsFormatter;
import tools.java.pats.models.formatters.ValuesFormatter;
import tools.java.pats.models.formatters.EmbeddedSelects.Factory.EmbeddedSelectsFormatterFactory;
import tools.java.pats.models.string.utils.FindIndexesForStringWithinParens;
import tools.java.pats.models.string.utils.StringIndexes;
import tools.java.pats.models.string.utils.sql.RejoinColumnsWithinParens;
...
public class Node implements Query, Serializable, ProjectStaticConstants {
    ...
    protected String formatEmbeddedSelect(int indent,
        ...
        EmbeddedSelectsFormatter esf =
                EmbeddedSelectsFormatterFactory.getFormatter(indent, tab, stringIndentAmount, selectedStyle);
