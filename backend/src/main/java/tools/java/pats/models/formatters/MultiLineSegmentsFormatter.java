package tools.java.pats.models.formatters;
...
import tools.java.pats.models.string.utils.sql.CheckForEmbeddedSelect;
            ...
            if(cfs.isEmbeddedSelect(s)) {
                ...
                if (! newSql.isEmpty()) {
                    EmbeddedSelectsFormatter esf =
                            EmbeddedSelectsFormatterFactory.getFormatter(TWO_INDENTS, tab, stringIndentAmount, selectedStyle);
